...
<@header name="归档目录 | ${config.siteName}" keywords="归档目录" description="归档目录" canonical="/archives"></@header>

<div class="container custome-container">
    <nav class="breadcrumb">
        <a class="crumbs" name="返回首页" href="${config.siteUrl}" data-toggle="tooltip" data-placement="bottom"><i class="fa fa-home"></i>首页</a> <i
                                                ...
                                                <li class="month-li">
                                                    ...
                                                    <ul class="list-box" style="display: none;">
                                                        <#list archives[dateTime] as article>
                                                            <li class="article-item"><a href="${config.siteUrl}/article/${article.id?c}" rel="bookmark" name="" data-toggle="tooltip" data-placement="bottom" data-original-name="${article.title}">${article.title}</a> </li>
                                                        </#list>
                                                    </ul>
                                                </li>
                                            </#list>
...
<@footer>
    ...
    <script src="https://v1.hitokoto.cn/?encode=js&select=.hitokoto%27);dom=$('.hitokoto');for(var i=0;i<dom.length;i%2B%2B){dom[i].innerText=hitokoto;}})()//" defer></script>
</@footer>
</@compress>