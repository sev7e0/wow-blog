                    ...
                    <#list page.list as item>
                        <article class="fade-in">
                            ...
                            <div class="entry-content">
                                ...
                                <span class="date" data-toggle="tooltip" data-placement="bottom"><i
                                            class="fa fa-clock-o fa-fw"></i>${item.createTime?string('yyyy-MM-dd')}</span>
                                <span class="views" data-toggle="tooltip" data-placement="bottom"><i
                                ...
                                <a href="${config.siteUrl}/article/${item.id?c}" rel="bookmark" data-toggle="tooltip"
                                   data-placement="bottom">阅读全文</a>
                            </span>
                            </div>
                        </article>
                    </#list>
