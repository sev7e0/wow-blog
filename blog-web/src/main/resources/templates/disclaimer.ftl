...
<@header name="免责声明 | ${config.siteName}" keywords="免责声明" description="免责声明" canonical="/disclaimer"></@header>
            ...
            <div class="blog-body overflow-initial fade-in">
                <div class="blog-info overflow-initial">
                    <div class="bottom-line">
                        ...
                        <p>作者：<a href="${config.siteUrl}" name="网站作者">${config.authorName}</a>&nbsp;&nbsp;&nbsp;&nbsp; 发布时间：2018年3月16日</p>
                    </div>
                    <div class="disclaimer-body">
                        <ul class="list-unstyled disclaimer-box">
                            ...
                            <li>4、如果本网站转载的文章不符合作者的版权声明或者作者不想让本网站转载您的文章，<a href="mailto:yadong.zhang0415@gmail.com" target="_blank" name="点击给我发邮件" rel="external nofollow"><i class="fa fa fa-envelope fa-fw"></i>请邮件告知</a>，本站将会在第一时间删除相关信息！</li>
