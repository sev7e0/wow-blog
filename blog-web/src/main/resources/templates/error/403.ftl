            ...
            <div class="col-md-6 right">
                <blockquote class="pull-left">
                    ...
                    <ol>
                        ...
                        <li>2.文明上网，勿刷流量！</li>
                        <li>3.请联系<a target="_blank" href="javascript:void(0);" name="点击QQ联系我"onclick="window.open('tencent://message/?uin=${config.qq}&amp;Site=www.${config.domain}&amp;Menu=yes')" rel="external nofollow">网站管理员</a></strong></li>
                    </ol>
                    <div class="clear"></div>
                </blockquote>
            </div>
