...
<@header name="友情链接 | ${config.siteName}"
    keywords="${config.siteName},友情链接交换"
    description="${config.siteName}，个人技术博客，友情链接交换"
    canonical="/links">
</@header>
    ...
    <div class="container custome-container">
        ...
        <div class="row">
            <@blogHeader name="友情链接"></@blogHeader>
            <div class="col-sm-12 blog-main">
                <div class="blog-body expansion">
                    <h4 class="custom-title"><strong>友链须知</strong></h4>
                    <div class="link-info">
                        <ul class="list-unstyled">
                            <li>菜鸡的技术博客</li>
                            <li>用于记录成长路上留下的脚印</li>
                            <li>特别提醒：<abbr title="禁止友链的网站">没事瞎搞的，再就是三天两头断网的就别申请了哦～</abbr></li>
                            <li>
                                <blockquote>
                                    <ul class="list-unstyled">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" style="overflow: hidden">
                    ...
                    <form class="form-horizontal col-sm-12" role="form" action="/api/autoLink" method="post" id="autoLinkForm" style="padding-left: 15px;">
                        ...
                        <div class="form-group has-info">
                            <div class="input-group input-logo">
                                <input type="text" class="form-control" name="description" placeholder="介绍一下你的方向吧" style="padding-left: 88px;">
