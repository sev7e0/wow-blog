    ...
    <#if articleDetail?exists>
        <div class="sidebar-module">
            ...
            <div class="div-quote">
                ...
                <p id="hitokoto" style="margin-left: 15px;">${notice.content}</p>
            </div>
        </div>
    <#else>
        <div class="sidebar-module" style="position: relative;">
            <h5 class="custom-title"><i class="fa fa-hand-peace-o fa-fw icon"></i><strong>关于我</strong>
                <small></small>
            </h5>
            <div class="widget">
                <div id="feed_widget">
                    <div class="feed-about">
                        <ul class="list-unstyled">
                            ...
                            <li><i class="fa fa-envelope-o fa-fw"></i>邮箱：
                                <small><a href="mailto:${config.authorEmail}" name="email" target="_blank"
                                          rel="external nofollow">sev7e0@mail.com</a></small>
                            <li><i class="fa fa-github fa-fw"></i>github：
                                <small><a href="${config.github}" name="github" target="_blank" rel="external nofollow">sev7e0</a>
                                </small>
                            </li>
                            </li>
                            <!-- <li>
            ...
            <#if tagsList?exists && (tagsList?size > 0)>
                <#list tagsList as item>
                    <a style="font-size: <@zhydTag method="random" max="15" min="10">${random}</@zhydTag>px;margin: 5px;"
                       href="${config.siteUrl}/tag/${item.id?c}" name="${item.name?if_exists}" data-toggle="tooltip"
    ...
    <div class="sidebar-module">
        <ul class="nav nav-tabs sidebar-tabs" role="tablist">
            ...
            <li role="presentation"><a href="#messages" aria-controls="messages" role="tab" data-toggle="tab"><i
                            class="fa fa-random"></i>随机文章</a></li>
        </ul>
                    ...
                    <@articleTag method="recentArticles" pageSize="10">
                        <#if recentArticles?exists && (recentArticles?size > 0)>
                            <#list recentArticles as item>
                                <li>
                                    <a href="${config.siteUrl}/article/${item.id?c}" name="${item.title}"
    ...
    <div class="sidebar-module">
        ...
        <ul class="ul-default site-info">
            <@zhydTag method="siteInfo">
                ...
                <li><i class="fa fa-users fa-fw"></i> <span class="online">在线人数：1</span>人</li>
