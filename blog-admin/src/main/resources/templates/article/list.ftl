                    ...
                    <div class="<#--table-responsive-->">
                        <div class="btn-group hidden-xs" id="toolbar">
                            <@shiro.hasPermission name="article:publish">
                                <a class="btn btn-default" name="发表文章" href="/article/publishMd"> <i class="fa fa-pencil"></i> 发表文章 </a>
                            </@shiro.hasPermission>
                            ...
                            <#-- 由草稿状态批量修改为已发布状态 -->
                            <@shiro.hasPermission name="article:publish">
                                <button id="btn_update_status" type="button" class="btn btn-default" name="批量发布">
                                    <i class="fa fa-bullhorn"></i> 批量发布
                                </button>
                            </@shiro.hasPermission>
                            <@shiro.hasPermission name="article:batchPush">
                                <button id="btn_push_ids" type="button" class="btn btn-info" name="批量推送">
...
<script>
    ...
    function operateFormatter(code, row, index) {
        ...
        var operateBtn = [
            '<@shiro.hasPermission name="article:push"><a class="btn btn-xs btn-info btn-push" name="推送" data-id="' + trId + '"><i class="fa fa-send-o"></i></a></@shiro.hasPermission>',
            ...
            columns: [
                {
                    ...
                    field: 'recommended',
                    title: '推荐 <i class="fa fa-question-circle-o" name="推荐的文章会在首页滚动显示"></i>',
                    editable: false,
                    width: '50px',
                    formatter: function (code, row, index) {
                        var checked = code ? 'checked' : '';
