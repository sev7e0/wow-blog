...
<head>
    ...
    <link href="https://cdn.bootcss.com/twitter-bootstrap/3.3.0/css/bootstrap.min.css" rel="stylesheet">    <link href="https://cdn.bootcss.com/jquery-confirm/3.3.2/jquery-confirm.min.css" rel="stylesheet">
    ...
    <#if footerHtml>
        <footer>
            <div class="pull-right">
                Copyright © 2019 Powered by OneBlog. All Rights Reserved.
            </div>
            <div class="clearfix"></div>
        </footer>
    </#if>
            ...
            <div class="modal-body material-body">
                <div class="btn-group" style="width: 100%;margin: 0 5px 5px 5px;padding: 0 0 10px 0;border-bottom: 1px solid #e7e7eb;">
                    <form action="" id="materialForm">
                        ...
                        <button id="btn-material-upload" type="button" class="btn btn-success btn-md" name="本地上传">
