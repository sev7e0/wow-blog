                ...
                <ul class="list-unstyled">
                    <@articleTag method="hotList" pageSize="10">
                        <#if hotList?exists && (hotList?size > 0)>
                            ...
                            <li class="title word-prase"><a href="${config.siteUrl}/article/${item.id?c}" name="${item.title}">${item.title}</a></li>
                            <li class="count"><span name="浏览人次：${item.lookCount?c}">${item.lookCount?c}</span></li>
                            </#list>
                        </#if>
                    </@articleTag>
                </ul>
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        <div class="x_panel statistics-box">
            <div class="x_title">
                ...
                <ul class="nav navbar-right panel_toolbox">
                    <li><a href="/articles" target="_blank" name="查看更多"><i class="fa fa-ellipsis-h"></i></a></li>
                    <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a></li>
                </ul>
                <div class="clearfix"></div>
            </div>
                ...
                <table class="table table-bordered recentArticles">
                    ...
                    <@articleTag method="recentArticles" pageSize="5">
                        <#if recentArticles?exists && (recentArticles?size > 0)>
                            ...
                            <tr>
                                <th class="title"><div class="word-prase"><a href="${config.siteUrl}/article/${item.id?c}" name="${item.title}">${item.title}</a></div></th>
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        <div class="x_panel statistics-box">
            <div class="x_title">
                ...
                <ul class="nav navbar-right panel_toolbox">
                    <li><a href="/comments" target="_blank" name="查看更多"><i class="fa fa-ellipsis-h"></i></a></li>
                    <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a></li>
                </ul>
                <div class="clearfix"></div>
            </div>
